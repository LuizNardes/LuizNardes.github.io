...
// }
include("banco_configuracao/config.php");
$sql = "SELECT * from (SELECT a.auditor, case when a.colaborador is not null then a.colaborador when b.colaborador is not null then b.colaborador 
...
from (SELECT colaborador,auditor, convert(decimal(18,2),avg(convert(decimal(18,2),nota_formulario)))AS nota from FORMULARIO_ADM_USO_PESSOAL
...
full outer join (SELECT colaborador,auditor, convert(decimal(18,2),avg(convert(decimal(18,2),nota_formulario)))AS nota from FORMULARIO_ADM_USO_PESSOAL
