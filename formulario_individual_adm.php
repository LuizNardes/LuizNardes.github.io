...
<div style="width: 100%;float: left;height: 20vh;">
        <div style="width:100%;float: left;height: 6vh">
            ...
            <div class="divisor2 centralizado" id="colaborador">
        ...
        <div style="width: 100%;float: left;height: 6vh">
            ...
            <div  class="divisor2 centralizado" id="area_referencia">
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha1">
                <input type="checkbox" name="form4_0" id="form4_0" class="checkbox_form4">
            </div>
            <div class="observacoes-item linha1">
                <textarea style="width: 100%;resize: none;height: 90%" id="form4_0_obs" name="form4_0_obs"></textarea>
            </div>
            <div class="foto-item linha1">
                <a  id="form4_0_file" target="_blank"> Anexo</a>
            </div>
        </div>
     </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha1">
                <input type="checkbox" name="form4_1" id="form4_1"  class="checkbox_form4">
            </div>
            <div class="observacoes-item linha1">
                <textarea style="width: 100%;resize: none;height: 90%" id="form4_1_obs" name="form4_1_obs"></textarea>
            </div>
            <div class="foto-item linha1">
                <a  id="form4_1_file" target="_blank"> Anexo</a>
            </div>
        </div>
     </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha1">
                <input type="checkbox" name="form4_2" id="form4_2" class="checkbox_form4">
            </div>
            <div class="observacoes-item linha1">
                <textarea style="width: 100%;resize: none;height: 90%" id="form4_2_obs" name="form4_2_obs"></textarea>
            </div>
            <div class="foto-item linha1">
                <a  id="form4_2_file" target="_blank"> Anexo</a>
            </div>
        </div>
     </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha1">
                <input type="checkbox" name="form4_3" id="form4_3" class="checkbox_form4">
            </div>
            <div class="observacoes-item linha1">
                <textarea style="width: 100%;resize: none;height: 90%" id="form4_3_obs" name="form4_3_obs"></textarea>
            </div>
            <div class="foto-item linha1">
                <a  id="form4_3_file" target="_blank"> Anexo</a>
            </div>
        </div>
     </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha4">
                <input type="checkbox" name="form4_4" id="form4_4"   class="checkbox_form4">
            </div>
            <div class="observacoes-item linha4">
                <textarea style="width: 100%;resize: none;height: 90%" id="form4_4_obs" name="form4_4_obs"></textarea>
            </div>
            <div class="foto-item linha4">
                <a  id="form4_4_file" target="_blank"> Anexo</a>
            </div>
        </div>
     </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha1">
                <input type="checkbox" name="form4_5" id="form4_5"  class="checkbox2_form4 check-form2">
            </div>
            <div class="observacoes-item linha1">
                <textarea style="width: 100%;resize: none;height: 90%" id="form4_5_obs" name="form4_5_obs"></textarea>
            </div>
            <div class="foto-item linha1">
                Nota MC
            </div>
	 ...
	 <script type="text/javascript">
        ...
        $("input[type='checkbox']").prop("disabled",true);
	 	function carregar_dados(){
	 		...
	 		var id = "<?php echo $id?>";
	 		$.ajax({
	            url: 'informacoes_formulario_individual_adm.php',
	            dataType: 'json',
	            type: 'post',
	            data:{id:id},
	            success: function(dados){

	            	$("#colaborador").html(dados[0].colaborador);
					$("#area_referencia").html(dados[0].area_referencia);
					$("#auditor").html(dados[0].auditor);
					$("#data_hoje").html(dados[0].data);

                    //UTILIZAÇÃO
                    if(dados[0].senso1_utilizacao == "checked"){
                        $("#form4_0").prop("checked",true);
                    }
                    if(dados[0].upload1 == ""){
                        $("#form4_0_file").css("visibility" , "hidden");
                    }else{
                        $("#form4_0_file").css("visibility" , "visible");
                        $("#form4_0_file").attr("href" , dados[0].upload1);
                    }
                    $("#form4_0_obs").text(dados[0].senso1_utilizacao_obs);

                    //ORGANIZAÇÃO
                    if(dados[0].senso1_organizacao == "checked"){
                        $("#form4_1").prop("checked",true);
                    }
                    if(dados[0].upload2 == ""){
                        $("#form4_1_file").css("visibility" , "hidden");
                    }else{
                        $("#form4_1_file").css("visibility" , "visible");
                        $("#form4_1_file").attr("href" , dados[0].upload2);
                    }
                    $("#form4_1_obs").text(dados[0].senso1_organizacao_obs);

                    //LIMPEZA
                    if(dados[0].senso1_limpeza == "checked"){
                        $("#form4_2").prop("checked",true);
                    }
                    if(dados[0].upload3 == ""){
                        $("#form4_2_file").css("visibility" , "hidden");
                    }else{
                        $("#form4_2_file").css("visibility" , "visible");
                        $("#form4_2_file").attr("href" , dados[0].upload3);
                    }
                    $("#form4_2_obs").text(dados[0].senso1_limpeza_obs);

                     //CONSERVAÇÃO
                    if(dados[0].senso1_conservacao == "checked"){
                        $("#form4_3").prop("checked",true);
                    }
                    if(dados[0].upload4 == ""){
                        $("#form4_3_file").css("visibility" , "hidden");
                    }else{
                        $("#form4_3_file").css("visibility" , "visible");
                        $("#form4_3_file").attr("href" , dados[0].upload4);
                    }
                    $("#form4_3_obs").text(dados[0].senso1_conservacao_obs);
                    ...
                    if(dados[0].upload5 == ""){
                        $("#form4_4_file").css("visibility" , "hidden");
                    }else{
                        $("#form4_4_file").css("visibility" , "visible");
                        $("#form4_4_file").attr("href" , dados[0].upload5);
                    }
                    $("#form4_4_obs").text(dados[0].senso1_disciplina_obs);
                    //senso 2
                    if(dados[0].senso2_melhoria == "checked"){
                            $("#form4_5").prop("checked",true);
                        }
                        $("#form4_5_obs").text(dados[0].senso2_melhoria_obs);

                    $("#nota_mc_form4").val(dados[0].nota_mc);
                    $("#nota_form4").val(dados[0].nota_formulario);
