 ...
 <div style="width: 100%;float: left;height: 20vh;">
        ...
        <div style="width: 100%;float: left;margin-top: 0px ">
            <div style="width: 100%;float: left">
                ...
                <div class="status-item linha4">
                    <input type="checkbox"  id="form2_0" name="form2_0"  class="checkbox">
                </div>
                <div class="observacoes-item linha4">
                    <textarea style="width: 100%;resize: none;height: 90%" name="form2_0_obs" id="form2_0_obs" name="form2_0_obs"></textarea>
                </div>
                <div class="foto-item linha4">
                    <a  id="form2_0_file" target="_blank"> Anexo</a>
                </div>
            </div>
         </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha2">
                <input type="checkbox" name="form2_1" id="form2_1"  class="checkbox check-form2">
            </div>
            ...
            <div class="foto-item linha2">
                <a  id="form2_1_file" target="_blank"> Anexo</a>
            </div>
        </div>
     </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha4">
                <input type="checkbox" name="form2_2" id="form2_2"  class="checkbox check-form2">
            </div>
            <div class="observacoes-item linha4">
                <textarea style="width: 100%;resize: none;height: 90%" id="form2_2_obs" name="form2_2_obs"></textarea>
            </div>
            <div class="foto-item linha4">
                <a  id="form2_2_file" target="_blank"> Anexo</a>
            </div>
        </div>
     </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha4">
                <input type="checkbox" name="form2_3" id="form2_3" class="checkbox check-form2">
            </div>
            <div class="observacoes-item linha4">
                <textarea style="width: 100%;resize: none;height: 90%" id="form2_3_obs" name="form2_3_obs"></textarea>
            </div>
            <div class="foto-item linha4">
                <a  id="form2_3_file" target="_blank"> Anexo</a>
            </div>
        </div>
     </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha2">
                <input type="checkbox" name="form2_4" id="form2_4"   class="checkbox check-form2">
            </div>
            <div class="observacoes-item linha2">
                <textarea style="width: 100%;resize: none;height: 90%" id="form2_4_obs" name="form2_4_obs"></textarea>
            </div>
            <div class="foto-item linha4">
                <a  id="form2_4_file" target="_blank"> Anexo</a>
            </div>
        </div>
     </div>
    ...
    <div style="width: 100%;float: left;margin-top: 0px ">
        <div style="width: 100%;float: left">
            ...
            <div class="status-item linha1">
                <input type="checkbox" name="form2_5" id="form2_5"  class="checkbox2 check-form2">
            </div>
	 ...
	 <script type="text/javascript">
        ...
        $("input[type='checkbox']").prop("disabled",true);
	 	function carregar_dados(){
	 		...
	 		var id = "<?php echo $id?>";
	 		$.ajax({
	            url: 'informacoes_formulario_individual_industrial.php',
	            dataType: 'json',
	            type: 'post',
	            data:{id:id},
	            success: function(dados){
                    ...
                    if(dados[0].senso1_utilizacao == "checked"){
                        $("#form2_0").prop("checked",true);
                    }
                    if(dados[0].upload1 == ""){
                        $("#form2_0_file").css("visibility" , "hidden");
                    }else{
                        $("#form2_0_file").css("visibility" , "visible");
                        $("#form2_0_file").attr("href" , dados[0].upload1);
                    }
                    $("#form2_0_obs").text(dados[0].senso1_utilizacao_obs);

                    //ORGANIZAÇÃO
                    if(dados[0].senso1_organizacao == "checked"){
                        $("#form2_1").prop("checked",true);
                    }
                    if(dados[0].upload2 == ""){
                        $("#form2_1_file").css("visibility" , "hidden");
                    }else{
                        $("#form2_1_file").css("visibility" , "visible");
                        $("#form2_1_file").attr("href" , dados[0].upload2);
                    }
                    $("#form2_1_obs").text(dados[0].senso1_organizacao_obs);

                    //LIMPEZA
                    if(dados[0].senso1_limpeza == "checked"){
                        $("#form2_2").prop("checked",true);
                    }
                    if(dados[0].upload3 == ""){
                        $("#form2_2_file").css("visibility" , "hidden");
                    }else{
                        $("#form2_2_file").css("visibility" , "visible");
                        $("#form2_2_file").attr("href" , dados[0].upload3);
                    }
                    $("#form2_2_obs").text(dados[0].senso1_limpeza_obs);

                     //CONSERVAÇÃO
                    if(dados[0].senso1_conservacao == "checked"){
                        $("#form2_3").prop("checked",true);
                    }
                    if(dados[0].upload4 == ""){
                        $("#form2_3_file").css("visibility" , "hidden");
                    }else{
                        $("#form2_3_file").css("visibility" , "visible");
                        $("#form2_3_file").attr("href" , dados[0].upload4);
                    }
                    $("#form2_3_obs").text(dados[0].senso1_conservacao_obs);
                    ...
                    if(dados[0].upload5 == ""){
                        $("#form2_4_file").css("visibility" , "hidden");
                    }else{
                        $("#form2_4_file").css("visibility" , "visible");
                        $("#form2_4_file").attr("href" , dados[0].upload5);
                    }
                    $("#form2_4_obs").text(dados[0].senso1_disciplina_obs);
                    //senso 2
                    if(dados[0].senso2_melhoria == "checked"){
                            $("#form2_5").prop("checked",true);
                        }
                        $("#form2_5_obs").text(dados[0].senso2_melhoria_obs);

                    $("#nota_mc_form2").val(dados[0].nota_mc);
                    $("#nota_form2").val(dados[0].nota_formulario);
